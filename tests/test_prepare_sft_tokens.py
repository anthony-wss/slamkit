...
@pytest.fixture
def tokeniser_with_special_tokens():
    """Initialize tokeniser and add special tokens."""
    ...
    tokeniser.text_tokeniser.add_special_tokens(
    ...
    return tokeniser, im_start_id, im_end_id, newline_id


@pytest.fixture
def test_sft_sample():
    """Create a test SFT sample."""
    return {
...
class TestProcessSFTSample:
    """Test processing a single SFT sample."""

    def test_process_sft_sample(self, tokeniser_with_special_tokens, test_sft_sample):
        """Test processing a single SFT sample."""
        tokeniser, im_start_id, im_end_id, newline_id = tokeniser_with_special_tokens
...
class TestChatMLFormatting:
    ...
    def test_chatml_formatting(self, tokeniser_with_special_tokens, test_sft_sample):
        """Test ChatML formatting structure."""
        tokeniser, im_start_id, im_end_id, newline_id = tokeniser_with_special_tokens
        ...
        print(f"✓ Sequence structure correct")


class TestLabelMasking:
    """Test label masking."""

    def test_label_masking(self, tokeniser_with_special_tokens, test_sft_sample):
...
@pytest.mark.slow
class TestEndToEnd:
    """Test end-to-end processing with file I/O (marked as slow)."""

    def test_end_to_end(self, tokeniser_with_special_tokens):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            output_path = os.path.join(tmpdir, "sft_tokens.jsonl")
            processed_count = 0
    ...
    def test_with_hydra_config(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert 'tokeniser' in cfg
            assert 'data_path' in cfg
            assert 'out_path' in cfg
